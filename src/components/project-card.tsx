      ...
      >
        {video && (
          <video
            ...
            muted
            playsInline
            className="rounded-lg bg-gray-100 pointer-events-none mx-auto h-100 w-full object-cover object-top" // needed because random black line at bottom of video
          />
        )}
        {image && (
          <Image
            ...
            width={500}
            height={300}
            className="rounded-lg h-100 w-full overflow-hidden object-cover object-top"
          />
        )}
      </Link>
